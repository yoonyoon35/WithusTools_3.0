...
export const comprehensivePropertyTaxFairRatioCalculation2026GuideMeta = {
  ...
  description:
    "2026년 8월 3일 정부안 기준 종부세 공정시장가액비율 60%·70%·80% 가정 시 1세대1주택·2주택 공시가격별 연간 보유세(재산세·지방교육세·종부세·농특세), 시행령 공제할 재산세 공식과 20억·25억 예시를 표로 정리했습니다.",
  updated: "2026년 8월 3일",
} as const;
    ...
    <>
      <section className="space-y-3" aria-labelledby="guide-cptfr-intro">
        ...
        <p>
          ...
          곱해 산출합니다. 2026년 현재 종부세 비율은 <strong>60%</strong>이고, 8·3 정부안은 2027년부터{" "}
          <strong>70%</strong>, 3주택·조정지역은 2028년부터 <strong>80%</strong>까지 단계 인상합니다.{" "}
          <strong>아직 법으로 바뀌지 않았습니다.</strong>
        </p>
        <p>
...
현행 종부세 공정시장가액비율: 60% (아래 70%·80%는 8·3 정부안)`}
        </pre>
        <p>
      ...
      <section className="space-y-4" aria-labelledby="guide-cptfr-onehome">
        ...
        <p className="text-muted-foreground text-sm">
          기본공제 12억 원, 재산세 공정 45%. 종부세 공정 60%(현행)·70%·80%(8·3 정부안) 비교. 연간 보유세(재산세+지방교육세+
          종부세+농특세) 기준.
        </p>
        <div className="overflow-x-auto rounded-lg border border-border">
      ...
      <section className="space-y-3" aria-labelledby="guide-cptfr-status">
        ...
        <p>
          8·3 정부안: 1세1주택·지방 1·2주택 <strong>60%→70%</strong>(2027~), 3주택·조정지역{" "}
          <strong>60%→70%→80%</strong>(2027~2028). 현재 적용 중인 비율은 <strong>60%</strong>입니다.{" "}
          <Link href="/guide/holding-capital-gains-tax-increase-2026-guide" className="text-primary underline-offset-4 hover:underline">
            세제개편안 총정리
          </Link>
          가이드에서 전체 개편 내용을 볼 수 있습니다.
        </p>
      </section>
      ...
      >
        ...
        <p>
          <Link
            ...
            className="text-primary font-medium underline-offset-4 hover:underline"
          >
            → 보유세·양도세 정부안 전체는 관련 가이드에서 확인할 수 있습니다.
          </Link>
        </p>
      </aside>
    </>
