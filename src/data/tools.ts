...
export const TOOLS: Tool[] = [
  ...
  },
  {
    id: "calculator-tools",
    title: "Calculator",
    description: "Average calculator, BMI calculator, GPA calculator, percentage calculator, programmer calculator, and simple scientific calculator for everyday math",
    category: "calculator",
    icon: "calculator",
