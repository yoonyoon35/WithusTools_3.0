...
const PATH_TITLES: Record<string, string> = {
  ...
  "/tools/gif-converter/heic": "HEIC to GIF",
  "/tools/gif-converter/heif": "HEIF to GIF",
  "/tools/gif-converter/avif": "AVIF to GIF",
  "/tools/gif-converter/bmp": "BMP to GIF",
  "/tools/gif-converter/png": "PNG to GIF",
  "/tools/gif-converter/svg": "SVG to GIF",
  "/tools/gif-converter/tiff": "TIFF to GIF",
  "/tools/gif-converter/webp": "WEBP to GIF",
  "/tools/gif-converter/psd": "PSD to GIF",
  "/tools/gif-converter/jfif": "JFIF to GIF",
  "/tools/gif-converter/ico": "ICO to GIF",
  "/tools/gif-converter/ai": "AI to GIF",
  "/tools/gif-converter/dng": "DNG to GIF",
  "/tools/gif-converter/cr2": "CR2 to GIF",
  "/tools/gif-converter/cr3": "CR3 to GIF",
  "/tools/gif-converter/tga": "TGA to GIF",
  "/tools/gif-converter/jpg": "JPG to GIF",
  "/tools/gif-converter/pdf": "PDF to GIF",
