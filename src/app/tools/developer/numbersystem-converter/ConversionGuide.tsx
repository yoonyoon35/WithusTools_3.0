  ...
  return (
    <div className="rounded-lg border border-slate-700/80 bg-slate-800/40 p-5">
      ...
      <div className="mb-4 border-l-4 border-blue-500 bg-slate-900/40 py-2 pl-3 text-sm text-slate-300">
        First express the <strong className="text-slate-100">left</strong> format as a decimal integer, then rewrite
        that integer in the <strong className="text-slate-100">right</strong> format. The calculator automates both
        steps.
      </div>
...
function WorkedExampleBlock({
  ...
  return (
    <div className={exampleIndex === 2 ? "mt-8 border-t border-slate-700 pt-8" : ""}>
  ...
  return (
    ...
    >
      ...
      <p className="mb-8 text-sm leading-relaxed text-slate-400">
        Three steps: symbols → the right math move for <em>this</em> pair → a tiny worked layout you can copy on paper.
      </p>
