...
export default function VolumePairCalculator({ fromKey, toKey }: VolumePairCalculatorProps) {
  ...
  const fromLabel = VOLUME_UNITS[fromKey].nameSg ?? VOLUME_UNITS[fromKey].name;
  const toLabel = VOLUME_UNITS[toKey].nameSg ?? VOLUME_UNITS[toKey].name;
