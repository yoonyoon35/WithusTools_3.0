...
export default function EnergyPairCalculator({ fromKey, toKey }: EnergyPairCalculatorProps) {
  ...
  const fromLabel = ENERGY_UNITS[fromKey].nameSg ?? ENERGY_UNITS[fromKey].name;
  const toLabel = ENERGY_UNITS[toKey].nameSg ?? ENERGY_UNITS[toKey].name;
