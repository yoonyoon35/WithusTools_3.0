...
export const IMAGE_INDEX_GUIDE: ImageGuideSection = {
  usage: [
    "Pick the tool by task: compress, convert, edit, or draw.",
  ...
  about: [
    ...
    "It covers common needs: smaller files, format compatibility, quick edits, and lightweight drawing.",
  ...
  advantages: [
    ...
    "Compression, conversion, editing, and drawing in one place.",
