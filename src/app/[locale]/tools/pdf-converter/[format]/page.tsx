...
import type { ImageToPdfFormat } from "../ImageToPdfConverter";
...
export async function generateMetadata({
  ...
  const metaPath = `/tools/pdf-converter/${format}`;
...
export default async function PDFConverterFormatPage({
  ...
  const hubContent = getToolContentEntry(toolContent, "/tools/pdf-converter");
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <ImageToPdfConverter format={format as ImageToPdfFormat} />
