...
const META_PATH = "/tools/jpg-converter";
...
const JPG_PATHS = JPG_CONVERTER_FORMATS.map(
  (format) => `/tools/jpg-converter/${format}`
) as readonly string[];

export default async function JPGConverterIndexPage({
  params,
}: {
  params: { locale: string };
}) {
