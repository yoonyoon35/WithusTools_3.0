...
const META_PATH = "/tools/language/hiragana-study";
...
const HIRAGANA_ROWS: [number, number][] = [
  [0, 5],
  [5, 5],
  [10, 5],
  [15, 5],
...
export default function HiraganaStudy() {
  ...
  const speechLang = asText(toolUi.speechLang) || "ja-JP";
  ...
  }, [selectedItem, speak, speechLang, resolvePronunciation]);
  ...
  }, [practiceSheetMode, resolvePronunciation]);
      ...
      <div className="flex flex-col items-center gap-6 lg:flex-row lg:justify-center lg:items-start">
        <div className="flex-shrink-0 rounded-xl border border-border bg-surface p-6">
          ...
          <div className="space-y-6">
            {HIRAGANA_ROWS.map(([start, count], rowIndex) => (
