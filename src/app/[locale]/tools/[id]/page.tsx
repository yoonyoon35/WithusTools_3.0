...
export default function ToolPage({
  ...
  if (id === "ssh-key-gen") {
    redirect(`/${locale}/tools/ssh/`);
  }
  if (id === "hash-calculator") {
    redirect(`/${locale}/tools/hash-calculator/`);
  }
  if (id === "time-tools") {
    redirect(`/${locale}/tools/time/`);
  }
  if (id === "image-tools") {
    redirect(`/${locale}/tools/image/`);
  }
  if (id === "text-tools") {
    redirect(`/${locale}/tools/text/`);
  }
  if (id === "random-tools") {
    redirect(`/${locale}/tools/random/`);
  }
  if (id === "calculator-tools") {
    redirect(`/${locale}/tools/calculator/`);
  }
