...
export default function WeightPairCalculator({ fromKey, toKey }: WeightPairCalculatorProps) {
  ...
  const fromLabel = WEIGHT_UNITS[fromKey].nameSg ?? WEIGHT_UNITS[fromKey].name;
  const toLabel = WEIGHT_UNITS[toKey].nameSg ?? WEIGHT_UNITS[toKey].name;
