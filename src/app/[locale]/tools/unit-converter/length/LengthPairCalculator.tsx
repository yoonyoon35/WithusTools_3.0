...
export default function LengthPairCalculator({ fromKey, toKey }: LengthPairCalculatorProps) {
  ...
  const fromLabel = LENGTH_UNITS[fromKey].nameSg ?? LENGTH_UNITS[fromKey].name;
  const toLabel = LENGTH_UNITS[toKey].nameSg ?? LENGTH_UNITS[toKey].name;
