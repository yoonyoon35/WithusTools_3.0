...
function normalizeMetaPath(pathname: string): string {
  ...
  return noLocale.startsWith("/tools/") ? noLocale : "/tools/unit-converter/digital/gigabyte-to-megabyte";
}

export default function DigitalPairCalculator({ fromKey, toKey, metaPath }: DigitalPairCalculatorProps) {
  ...
  const fromLabel = digitalUnitLabel(ui, fromKey, "nameSg");
  const toLabel = digitalUnitLabel(ui, toKey, "nameSg");
