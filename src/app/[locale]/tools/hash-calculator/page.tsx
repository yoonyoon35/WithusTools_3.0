...
const META_PATH = "/tools/hash-calculator";
...
const HASH_PATHS = HASH_CALCULATOR_ALGORITHMS.map(
  (algorithm) => `/tools/hash-calculator/${algorithm}`
) as readonly string[];

export default async function HashCalculatorIndexPage({
  params,
}: {
  params: { locale: string };
}) {
