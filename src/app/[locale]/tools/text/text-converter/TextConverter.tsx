...
const META_PATH = "/tools/text/text-converter";
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border border-border bg-surface p-6">
        <h2 className="mb-3 text-lg font-semibold text-slate-100">{ui.textInput}</h2>
        <textarea
          id="inputText"
          value={input}
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-4 rounded-lg bg-slate-950/80 px-4 py-2 text-sm">
          ...
          <span className="text-slate-400">
            {ui.size}: <span className="font-medium text-slate-200">{textSize}</span>
          </span>
      ...
      <div className="rounded-xl border border-border bg-surface p-6">
        <h2 className="mb-3 text-lg font-semibold text-slate-100">{ui.convertedText}</h2>
        <textarea
          id="outputText"
          value={output}
          readOnly
