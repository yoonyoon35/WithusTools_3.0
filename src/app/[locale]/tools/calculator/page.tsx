...
const META_PATH = "/tools/calculator";
...
const CALCULATOR_PATHS = [
  ...
  "/tools/calculator/standard-deviation-calculator",
  "/tools/calculator/calculator",
  "/tools/calculator/gpa-calculator",
  "/tools/calculator/percentage-calculator",
  "/tools/calculator/programmer-calculator",
] as const;
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mx-auto mb-8 max-w-2xl text-center text-slate-400">
        ...
        <Link href="/tools/health" className="text-slate-200 underline">
          {hubUi.healthToolsLink ?? "Health Tools"}
        </Link>
        .
      </p>

      <HubToolGrid paths={CALCULATOR_PATHS} columnsClassName="sm:grid-cols-2" />
