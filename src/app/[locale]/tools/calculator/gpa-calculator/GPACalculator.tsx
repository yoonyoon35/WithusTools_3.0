...
export default function GPACalculator() {
  ...
  const useSampleData = () => {
    ...
    showToast(ui?.sampleLoaded ?? "Sample data loaded");
  };
          ...
          {courses.map((course) => (
            ...
            >
              ...
              <NumberInputWithStepper
                ...
                placeholder={ui.creditsPlaceholder}
                min={0}
                max={99}
                step={0.5}
                className="w-20"
                aria-label={ui.creditsPlaceholder}
              />
              <select
                value={course.grade}
              ...
              <button
                ...
                title={ui.deleteCourse}
                aria-label={ui.deleteCourse}
              >
                <svg
