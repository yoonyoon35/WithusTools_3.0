...
const TIME_PATHS = [
  "/tools/time/alarm-clock",
  "/tools/time/stopwatch",
  "/tools/time/timer",
  "/tools/time/pomodoro",
  "/tools/time/interval-timer",
  "/tools/time/date-difference",
  "/tools/time/calendar",
  "/tools/time/world-clock",
] as const;

export default async function TimeToolsIndexPage({
  params,
}: {
  params: { locale: string };
}) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <HubToolGrid paths={TIME_PATHS} columnsClassName="sm:grid-cols-2" />
