...
export function getNumberSystemOtherPairLinks(
  ...
  limit = 12
): { href: string; from: NumberSystemPairKey; to: NumberSystemPairKey; line2: string }[] {
  const links: { href: string; from: NumberSystemPairKey; to: NumberSystemPairKey; line2: string }[] = [];
